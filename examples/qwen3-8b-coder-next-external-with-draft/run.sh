#!/bin/bash
# External online training WITH draft model — Qwen3-Coder-Next
#
...
#
# Usage:
#   bash examples/qwen3-next-coder-external-with-draft/run.sh [EXTRA_ARGS...]
#
...
#   TARGET_MODEL          - Target model path (default: Qwen/Qwen3-Coder-Next)
...
TARGET_MODEL="${TARGET_MODEL:-Qwen/Qwen3-Coder-Next}"
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/qwen3-next-coder-external-with-draft}"
...
LOG_FILE="$LOG_DIR/qwen3_next_coder_external_with_draft_${TIMESTAMP}.log"
SGLANG_LOG="$LOG_DIR/qwen3_next_coder_sglang_with_draft_${TIMESTAMP}.log"
...
echo "=============================================="
echo "External Training - WITH Draft Model - Qwen3-Coder-Next"
echo "=============================================="
...
echo "  Send requests: bash examples/qwen3-next-coder-external-with-draft/send_requests.sh"
echo "=============================================="
wait "$training_pid"
training_exit=$?

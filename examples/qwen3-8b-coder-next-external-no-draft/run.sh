#!/bin/bash
# External online training WITHOUT draft model — Qwen3-Coder-Next
#
...
#
# Usage:
#   bash examples/qwen3-next-coder-external-no-draft/run.sh [EXTRA_ARGS...]
#
...
LOG_FILE="$LOG_DIR/qwen3_next_coder_external_no_draft_${TIMESTAMP}.log"
SGLANG_LOG="$LOG_DIR/qwen3_next_coder_sglang_no_draft_${TIMESTAMP}.log"
...
echo "=============================================="
echo "External Training - NO Draft Model - Qwen3-Coder-Next"
echo "=============================================="
...
echo "  Send requests: bash examples/qwen3-next-coder-external-no-draft/send_requests.sh"
echo "=============================================="

#!/bin/bash
# External online training WITHOUT draft model — Qwen3-4B
#
# This script:
...
#
# Usage:
#   bash examples/qwen3-4b-external-no-draft/run.sh [EXTRA_ARGS...]
#
...
LOG_FILE="$LOG_DIR/qwen3_4b_external_no_draft_${TIMESTAMP}.log"
SGLANG_LOG="$LOG_DIR/qwen3_4b_sglang_no_draft_${TIMESTAMP}.log"
...
echo "=============================================="
echo "External Training - NO Draft Model - Qwen3-4B"
echo "=============================================="
...
echo "  Send requests: bash examples/qwen3-4b-external-no-draft/send_requests.sh"
echo "=============================================="
wait "$training_pid"
training_exit=$?

#!/bin/bash
# External online training WITHOUT draft model — Qwen3-8B
#
# This script:
...
#
# Usage:
#   bash examples/qwen3-8b-external-no-draft/run.sh [EXTRA_ARGS...]
#
...
#   TARGET_MODEL          - Target model path (default: Qwen/Qwen3-8B)
...
LOG_FILE="$LOG_DIR/qwen3_8b_external_no_draft_${TIMESTAMP}.log"
SGLANG_LOG="$LOG_DIR/qwen3_8b_sglang_no_draft_${TIMESTAMP}.log"
...
echo "=============================================="
echo "External Training - NO Draft Model - Qwen3-8B"
echo "=============================================="
...
python3 -m aurora.train_entry \
    ...
    output_dir="$ROOT_DIR/outputs/qwen3-8b-external-no-draft" \
...
echo "  Send requests: bash examples/qwen3-8b-external-no-draft/send_requests.sh"
echo "=============================================="
wait "$training_pid"
training_exit=$?
